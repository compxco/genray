...
c No  namelist data.
      ...
      character t_*256        !Character variable for temporary use.
      character filetxt*128,filenc*128
        
      real*8  
     &            a,q0,pq,rho,rho2,drhodzb,
     &            ax,pi,gam,
     &            bz,br,bphi,bmod,psid,dpdzd,dpdrd,dpdzzd,dpdrrd,dpdzrd,
     &            dbzdz,dbzdr,dbzdph,dbrdz,dbrdr,dbrdph,
     &            dbphdz,dbphdr,dbpdph,
     &            dqdrho,dbmdz,dbmdr,dbmdph,
     &         	  dc2dz,dc2dr,dc2dph,dc2dnz,dc2dnr,dc2dm,
     &            w,v,
     &            te0,teb,
     &            powtott,powini,
     &		  dpsimax,
     ...
     &            lrzmax,
     &            i_go_to_previous_out_step
      common/one_no_nml/ a,q0,pq,rho,rho2,drhodzb,
     &            ax,pi,gam,
     &            bz,br,bphi,bmod,psid,dpdzd,dpdrd,dpdzzd,dpdrrd,dpdzrd,
     &            dbzdz,dbzdr,dbzdph,dbrdz,dbrdr,dbrdph,
     &            dbphdz,dbphdr,dbpdph,
...
c------------------------------------------------------------------
c i_go_to_previous_out_step=0 nothing to do
c                          =1 return to the previous 
c                              output point
c------------------------------------------------------------------ 
c prmt6_new output step used at i_go_to_previous_out_step=1 case
c-------------------------------------------------------------------
