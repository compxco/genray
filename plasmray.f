...
c       write(*,*)'plasmray 2 after vacray'
       ...
       r0=rp-1.d-10
       write(*,*)'in 2 z0,r0,zrmax,rmax',z0,r0,zrmax,rmax
       go to 10
c-------------------------------------------------------------------
...
c      if (isp.eq.10) then
      if (isp.eq.100) then
        write(*,*)'plasmray.f isp.eq.100 stpping'   
        stop
      endif
      p3=(p1+p2)*0.5d0
...
c------------------------------------------------------------------
     ...
     1 ias1r,ias2r,ias2r_Sm
      ...
      write(*,*)' in edgcor initial :z,r',z,r
1     continue
...
cSAP091127
      ...
      zu0=z
      ru0=r
      write(*,*)'edgcor after shift_rho_geom z,r',
     &shift_rho_geom,z,r
