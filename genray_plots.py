...
ax=plt.subplot(231) #-------------------------
plt.hold(True)
plt.title('$n_R$ $along$ $ray$',y=1.03)
for i in range(0,Nrays,1):  # i goes from 0 to Nrays-1
    if remainder(i,6)==0: col='b'
    if remainder(i,6)==1: col='g'
    if remainder(i,6)==2: col='r'
...
plt.subplot(232) #-------------------------
plt.hold(True)
plt.title('$n_Z$ $along$ $ray$',y=1.03)
for i in range(0,Nrays,1):  # i goes from 0 to Nrays-1
    if remainder(i,6)==0: col='b'
    if remainder(i,6)==1: col='g'
    if remainder(i,6)==2: col='r'
...
plt.subplot(233) #-------------------------
plt.hold(True)
plt.title(r'$n_\phi$'+' $along$ $ray$',y=1.03)
for i in range(0,Nrays,1):  # i goes from 0 to Nrays-1
    if remainder(i,6)==0: col='b'
    if remainder(i,6)==1: col='g'
    if remainder(i,6)==2: col='r'
...
plt.subplot(236) #-------------------------
plt.hold(True)
plt.title('$Lin.Damping$ $k_i$ $(cm^{-1})$',verticalalignment='center',y=1.03)
plt.xlabel('$R$ $along$ $ray$  $(cm)$')
for i in range(0,Nrays,1):  # i goes from 0 to Nrays-1
    if remainder(i,6)==0: col='b'
    if remainder(i,6)==1: col='g'
...
plt.hold(True)
plt.grid(True)
plt.title('$(\omega_{pe}/\omega)^2$  $along$ $ray$',y=1.03)
for i in range(0,Nrays,1):  # i goes from 0 to Nrays-1
    if remainder(i,6)==0: col='b'
    if remainder(i,6)==1: col='g'
    if remainder(i,6)==2: col='r'
